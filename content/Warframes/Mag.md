![[Pasted image 20250726094439.png|200]]![[Pasted image 20250726094453.png|200]]
...
Expel enemy forces with rapid repulsion, soon attracted and crushed by mere gestures. Become Origin's true magnetic north, the shield of the  [![](https://wiki.warframe.com/images/thumb/TennoIcon.png/32px-TennoIcon.png?3c7f6)](https://wiki.warframe.com/w/Tenno) [Tenno](https://wiki.warframe.com/w/Tenno), as the Electromagnetic Conduit, **Mag**. Sunder the armored into scraps and shrapnel, then return the recycled metals to their sender. Choose wisely, Tenno. Start your new journey with Mag as one of the three beginner Warframes.

**Mag** is a magnetic [Warframe](https://wiki.warframe.com/w/Warframe "Warframe") with crowd control. Her [Passive](https://wiki.warframe.com/w/Passive "Passive") has automatically vacuum nearby [Pickups](https://wiki.warframe.com/w/Pickups "Pickups").  [![](https://wiki.warframe.com/images/thumb/Pull130xWhite.png/32px-Pull130xWhite.png?f9f7e)](https://wiki.warframe.com/w/Pull) [Pull](https://wiki.warframe.com/w/Pull) generates a vortex that forcefully pulls enemies to her.  [![](https://wiki.warframe.com/images/thumb/Magnetize130xWhite.png/32px-Magnetize130xWhite.png?345a6)](https://wiki.warframe.com/w/Magnetize) [Magnetize](https://wiki.warframe.com/w/Magnetize) generates a field that pulls in all gunfire into its circumference while increasing their damage.  [![](https://wiki.warframe.com/images/thumb/Polarize130xWhite.png/32px-Polarize130xWhite.png?9fa6d)](https://wiki.warframe.com/w/Polarize) [Polarize](https://wiki.warframe.com/w/Polarize) releases a pulse that drains enemy [shields](https://wiki.warframe.com/w/Shield "Shield") and [armor](https://wiki.warframe.com/w/Armor "Armor") while dropping shards that Mag can pick up to project a damaging aura or be absorbed by Magnetize.  [![](https://wiki.warframe.com/images/thumb/Crush130xWhite.png/32px-Crush130xWhite.png?a0ff5)](https://wiki.warframe.com/w/Crush) [Crush](https://wiki.warframe.com/w/Crush) forcefully suspends nearby enemies before crushing their bones, inflicting  [![](https://wiki.warframe.com/images/thumb/Knockdown_b.png/32px-Knockdown_b.png?badc8)](https://wiki.warframe.com/w/Knockdown) [Knockdown](https://wiki.warframe.com/w/Knockdown) while recovering Mag's and her allies' shields.

## Abilities

### Passive
 [![](https://wiki.warframe.com/images/thumb/MagIcon272.png/31px-MagIcon272.png?3e890)](https://wiki.warframe.com/w/Mag) [Mag](https://wiki.warframe.com/w/Mag) automatically  [![](https://wiki.warframe.com/images/Mod_TT_20px.png?dec74)](https://wiki.warframe.com/w/Vacuum) [Vacuums](https://wiki.warframe.com/w/Vacuum) [Pickups](https://wiki.warframe.com/w/Pickups "Pickups") that are within **8** meters towards her.

### **[Pull](https://wiki.warframe.com/w/Pull)**
...
### **[Magnetize](https://wiki.warframe.com/w/Magnetize)**
...
> [!note]
> Armor breaks into Polarize Shards


### **[Crush](https://wiki.warframe.com/w/Crush)**
